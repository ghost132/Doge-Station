...
//big pile of shit below.
	...
	dat = {"<html>
				...
				<ol>
					<li><b>Parafuse</b> todas as pe�as no ch�o, usando a chave inglesa</li>
					<li>Adicione <b>cabos</b> a todas as pe�as(mesmo as que voc� nao consegue ver cabeado)</li>
					<li>Feche todos os paineis usando uma <b>chave de fenda</b> ou uma <b> furadeira</b></li>
				</ol>

				<h5>Apose parafusar, cabear, e fechar todos os paineis, siga as seguintes instru��es</h5>
				...
				<ol>
					...
					<li><font color='red'><b>Qunado a singularidade atingir um tamanho grande o suficiente para come�ar a se mover sozinho, abaixe a velocidade do acelerador de particulas para 0, mas n�o desligue</b></font></li>
...
/obj/item/weapon/book/manual/supermatter_engine
	...
	dat = {"Guia para voc� n�o explodir a esta��o com o SuperMatter,</br>
			-Alahu Al Kbhar</br>
...
/obj/item/weapon/book/manual/barman_recipes
	...
	dat = {"<html>
				...
				Aqui um guia para se tornar o fod�o das bebidas.
				...
				<h2>Caipirinha</h2>
				Misture 51 com suco de lim�o

				<h2>N�o tente isso</h2>
