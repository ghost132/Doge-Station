...
/datum/action/item_action/synthswitch
	...
	desc = "Muda o tipo de instrumento que você pode sintetisar no jogo."

/datum/action/item_action/synthswitch/Trigger()
	if(istype(target, /obj/item/device/instrument/piano_synth))
		var/obj/item/device/instrument/piano_synth/synth = target
		var/chosen = input("Escolhe o instrumento que voce quer usar", "Seleção de Instrumento", "piano") as null|anything in synth.insTypes
...
/datum/action/item_action/vortex_recall
	name = "Vortex Recall"
	desc = "Chama você e mais alguem perto para sintonizar a runa hierophant uma de cada vez.<br>Se não tiver nenhuma runa, você precisará produzir uma no local."
...
/datum/action/item_action/jetpack_stabilization
	name = "Colocar Estabilização do Jetpack"
