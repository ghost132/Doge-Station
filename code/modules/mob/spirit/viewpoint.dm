...
/obj/cult_viewpoint/verb/reach_out()
	...
	for(var/mob/spirit/mask/currentMask in spirits)
		if (currentMask.is_active())
			...
			to_chat(currentMask, "<span class='cultspeech'><span class='name'><a href='?src=[currentMask.UID()];track2=\ref[currentMask];track=\ref[usr]'>[get_display_name()]</a></span><span class='message'> has reached out to you.</span></span>")
...
/obj/cult_viewpoint/verb/pray_to_mask()
	...
	for(var/mob/spirit/spirit in spirits)
		to_chat(spirit, "<span class='cultspeech'><span class='name'><a href='?src=[spirit.UID()];track2=\ref[spirit];track=\ref[usr]'>[get_display_name()]</a> prays : </span><span class='message'>[input]</span></span>")
