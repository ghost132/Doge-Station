...
/datum/event/disease_outbreak/announce()
	event_announcement.Announce("Surto confirmado do risco biologico viral principal do nivel 7 a bordo da [station_name()]. Todo o pessoal deve conter o surto.", "Alerta de Risco Biologico", new_sound = 'sound/AI/outbreak7.ogg')
