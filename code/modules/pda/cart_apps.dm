...
/datum/data/pda/app/secbot_control
	name = "Acesso aos bots de Segurança"
	icon = "rss"
	template = "pda_secbot"
	category = "Security"
...
/datum/data/pda/app/mule_control
	name = "Controle do bot de entrega"
	icon = "truck"
	template = "pda_mule"
