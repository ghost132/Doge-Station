...
/datum/industry/proc/generateInCharacterProductArticle(product_name, datum/stock/S)
	var/datum/article/A = new /datum/article()
...
/datum/industry/agriculture/generateProductName(company_name)
	...
	var/list/suffix = list(" of farming", " multiplex", " +[rand(1,15)]", " [uppertext(pick(consonants))][rand(1000, 9999)]", " hybrid", " maximus", " extreme")
...
/datum/industry/it/generateProductName(company_name)
	...
	var/L = pick(uppertext(pick(consonants)), "Seed ", "Radiant ", "Robust ", "Pentathon ", "Athlete ", "Phantom ", "Semper Fi ")
	var/N = rand(0,99)
...
/datum/industry/communications/generateProductName(company_name)
	...
	var/L = pick("[lowertext(uppertext(pick(consonants)))]Phone ", "Universe ", "Xperience ", "Next ", "Engin Y ", "Cyborg ", "[uppertext(pick(consonants))]")
	var/N = rand(1,99)
...
/datum/industry/consumer/generateProductName(company_name)
...
/datum/industry/mining/generateProductName(company_name)
...
/datum/industry/defense/generateProductName(company_name)
