...
/obj/machinery/computer3/prison_shuttle
	...
	Topic(href, href_list)
		...
		if (href_list["sendtodock"])
			...
			src.temp += "Shuttle sent.<BR><BR><A href='?src=[UID()];mainmenu=1'>OK</A>"
			src.updateUsrDialog()
